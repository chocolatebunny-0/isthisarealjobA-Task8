...
def NScraper(searchTerm):
	...
	print("From people's reaction to " + searchTerm + ", there were " + str(noOfSearchTerms) + " comments "
	      "on nairaland")

	if (negative> 30):
	    return "This job has "+str(noOfSearchTerms)+" searches and is therefore likely to be fake"
	elif(negative>20):
	    return "This job has "+str(noOfSearchTerms)+" searches and is therefore hard to conclude on"
	elif (negative<20):
	    return "This job has "+str(noOfSearchTerms)+" searches and is therefore likely to be real"


#print(NScraper("andela"))